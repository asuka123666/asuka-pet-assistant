...
<body>
  <div class="menu">
    <button data-action="wave">挥手</button>
    <button data-action="jump">跳一下</button>
    <button data-action="review">查看</button>
    <button data-action="failed">生气</button>
    <button data-action="walk-left">向左走</button>
    <button data-action="walk-right">向右走</button>
    <button class="${randomWalkClass}" data-action="toggle-random-walk">${randomWalkLabel}</button>
    <button class="${quietModeClass}" data-action="quiet-mode">${quietModeLabel}</button>
    <button data-action="open-settings">设置</button>
    <button data-action="toggle-chat">对话</button>
    <button data-action="toggle-widget">小组件</button>
    <button data-action="hide-to-tray">隐藏到托盘</button>
